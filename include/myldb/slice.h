...
public:
    ...
    bool starts_with(const Slice& x) const {
        return ( (size_ >= x.size_) &&
                ...
                //memcmp(ptr1,ptr2,num):compare the first num bytes of 
                //content pointed by ptr1 and ptr2.
                //== 0 iff contents are equal 
                //>  0 iff first unequal byte of ptr1 has a greater value
                //<  0 iff                       ptr2
    }
